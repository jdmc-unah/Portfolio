    ...
    <section style={{ padding:'2rem', paddingBottom:'4rem' ,backgroundColor: window.secondary }} >
      ...
      >
         <Grid>
            ...
            gitLink= {`${gitHub}TiendaEnLinea-MVC`}  image={store} 
        ...
        <Grid>
            ...
            gitLink= {`${gitHub}AgroLink`} image={agrolink} 
        ...
        <Grid>
            ...
            gitLink= {`${gitHub}AppReservarCanchas`}  image={bookandplay} 
        ...
        <Grid>
            ...
            gitLink= {`${gitHub}BlogList-API`}  webLink={'https://bloglist-app-njab.onrender.com/'} image={blog} 
        ...
        <Grid>
            <ProjectItem title={'Autoverstat'} subheader="Septiembre, 2025" 
             webLink={'https://autoverstat.vercel.app/'} image={logo} 
            description="App web para taller de enderezado automotriz, desarrollada con React y Material UI. Permite agendar citas vía Google Calendar, ver la ubicación en un mapa interactivo y contactar fácilmente por redes sociales. Diseño moderno, funcional y adaptable a cualquier dispositivo. "
            />
        </Grid>
